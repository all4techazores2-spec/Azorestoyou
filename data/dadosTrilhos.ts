...
export const trilhosAcoresDados: Record<string, PontoRota[]> = {
  ...
  "PR03SMI_vista_rei_sete_cidades": [
    { lat: 37.8392, lng: -25.7941, altitude: 540, indicacao: "Comece no icónico Miradouro da Vista do Rei. Vista magnífica sobre as lagoas." },
    { lat: 37.8410, lng: -25.7915, altitude: 535, indicacao: "Mantenha-se à direita ao longo da cumeeira da caldeira." },
    { lat: 37.8480, lng: -25.7810, altitude: 480, indicacao: "Aproveite a vista sobre as lagoas Azul e Verde à sua esquerda." },
  ...
  "PR36SMI_rocha_relva": [
    ...
    { lat: 37.7612, lng: -25.7420, altitude: 120, indicacao: "Subida concluída! Chegou ao fim da Rocha da Relva." }
  ],
  "PR38SMI_canario_lagoa_azul": [
  ...
  "PR06SMI_lagoa_furnas": [
    { lat: 37.7712, lng: -25.3284, altitude: 280, indicacao: "Inicie o percurso junto às caldeiras de confeção do Cozido." },
    { lat: 37.7728, lng: -25.3308, altitude: 298, indicacao: "Siga pela margem da lagoa. Caminhada plana e relaxante." },
    { lat: 37.7750, lng: -25.3345, altitude: 350, indicacao: "Passagem pela icónica Capela neoclássica junto à margem." },
    { lat: 37.7732, lng: -25.3362, altitude: 282, indicacao: "Circuito da Lagoa concluído!" }
  ],
  "PR07SMI_pico_ferro_furnas": [
